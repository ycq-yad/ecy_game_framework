...
declare abstract class BaseContent {
     ...
     * 舞台创建完毕 校验平台逻辑处理
     *
     * 备注：因为下一帧才会开始渲染舞台 才有舞台正确的尺寸
     */
    abstract checkPlatform(): any;
    /**
     * 初始debug
     *
     * @param url
...
declare class ResUtil {
    ...
    /**
     * 快速加载组资源
     * 备注：切记不可重复使用必须一次加载完毕后再次使用
     *
     * @param groups 一些组
     * @param complet 加载完成时候
     * @param progress 加载过程中
     */
    fastLoadGroups(groups: string[], complet?: Function, progress?: Function): void;
    /**快速加载是否成功 */
    private isFastLoadGrpSucc;
    /**
     * 快速加载一些资源组
     *
     * @param resInfos
